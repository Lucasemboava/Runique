package com.emboava.auth.presentation.intro
...
import com.emboava.auth.presentation.R
...
fun IntroScreenRoot(
    ...
    IntroScreen(
        onAction = { action ->
            when (action) {
                IntroAction.OnSignInClick -> onSingInClick()
                IntroAction.OnSignUpClick -> onSingUpClick()
            }
        }
    )
}
